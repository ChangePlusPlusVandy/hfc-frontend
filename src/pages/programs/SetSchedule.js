    ...
    return (
        <div className="schedule-modal-container">
            <div className="schedule-modal-body">
                <button className="schedule-cancel-button" onClick={props.closeModal}>
                    X
                </button>
                    ...
                    <div className="set-times-container">
                        <div className="schedule-single-day">
                            ...
                            <div className="schedule-enter-time">
                                <input className="schedule-enter-input" type="text" placeholder="00" />
                                <h6>:</h6>
                                <input className="schedule-enter-input" type="text" placeholder="00" />
                                <h5>-</h5>
                                <input className="schedule-enter-input" type="text" placeholder="00" />
                ...
                <button className="submit-button schedule-submit-button" onClick={props.submitSchedule}>
                    Submit
                </button>
            </div>
        </div>
